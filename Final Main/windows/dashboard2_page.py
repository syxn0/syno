...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/resources/horizontal-bars.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/resources/account.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.label_16)
...
"")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/resources/dashboard.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dashboard_button.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/resources/printer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/resources/help.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 387, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/resources/arrow.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/resources/info.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.aboutus_button.setIcon(icon6)
...
"}")
        ...
        self.dashboard_icon.setIcon(icon2)
        ...
        self.logout_icon.setIcon(icon5)
        ...
        self.aboutus_icon.setIcon(icon6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Anikin Dagcuta"))
        self.label_12.setText(_translate("MainWindow", "00.00"))
        self.label_13.setText(_translate("MainWindow", "00.00"))
        ...
        self.label_14.setText(_translate("MainWindow", "00.00"))
        self.label_10.setText(_translate("MainWindow", "kWh : "))
        self.label_15.setText(_translate("MainWindow", "00.00"))
        self.label_11.setText(_translate("MainWindow", "Next Due :"))
        self.label_16.setText(_translate("MainWindow", "mm-dd-yy"))
